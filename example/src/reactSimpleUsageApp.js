...
import { reactComponent as Cropper, CropperPreview, imageUtils } from 'redux-cropper';
...
export default class App extends PureComponent {
	...
	onCropperReduxUpdate({image, cropBox, myState, canvas}) {
		...
		if (this.state.isBlobMode) { 
			this.refs.cropper.getBlob((blob)=>{
		...
		return (
			<div>
				...
				<div style={{display:'inline-block'}}>
					<Cropper 
					{...{...options, rotate}}
					onCropperReduxUpdate={this.onCropperReduxUpdate}
					ref="cropper"
					/>
				</div>
				{isBlobMode ? 
